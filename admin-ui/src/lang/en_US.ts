export default {
  ...
  paymentSettlement: {
    ...
    create: 'Create settlement batch',
    detail: 'Settlement details',
    number: 'Settlement number',
    provider: 'Provider',
    currency: 'Currency',
    window: 'UTC settlement window',
    gross: 'Gross payment',
    refunds: 'Refunds',
    chargebacks: 'Chargebacks',
    fees: 'Fees',
    net: 'Net settlement',
    payable: 'Payable to provider',
    receivable: 'Receivable from provider',
    calculate: 'Calculate',
    ...
    orderNo: 'Order number',
    amount: 'Amount',
    feePercent: 'Payment fee rate',
    fixedFee: 'Payment fixed fee',
    chargebackFee: 'Chargeback fixed fee',
    remark: 'Close remark',
    openReconciliation: 'Open payment reconciliation',
    noMutation: 'Closing a settlement records financial confirmation only and does not change payment orders, reversals, or wallet balances',
    permissionDenied: 'You do not have permission to view payment settlements',
    loadFailed: 'Failed to load payment settlements',
    detailFailed: 'Failed to load settlement details',
    retry: 'Retry',
    empty: 'No settlement batches',
    filteredEmpty: 'No settlement batches match the filters',
    emptyItems: 'No settlement events',
    emptyHistory: 'No action history',
    noEvidence: 'No reconciliation evidence',
    processing: 'Settlement calculation is in progress. Refresh later.',
    failed: 'Settlement calculation failed',
    providerRequired: 'Enter a payment provider',
    currencyRequired: 'Enter a three-letter currency code',
    windowRequired: 'Select a UTC settlement window',
    windowInvalid: 'The settlement window must be greater than zero and no longer than 31 days',
    remarkRequired: 'Enter a close remark',
    calculateConfirm: 'This creates immutable financial snapshots from processed payment events. Continue?',
    calculateAccepted: 'Settlement calculation completed',
    closed: 'Settlement batch closed',
    status: { CREATED: 'Created', CALCULATING: 'Calculating', CALCULATED: 'Calculated', CLOSED: 'Closed', FAILED: 'Failed' }
  },
  paymentSettlementReport: {
    ...
    exportFailed: 'Report export failed. Narrow the range or try again.',
    generatedAt: 'Generated at',
    groupBatches: 'Settlement batches in group',
    number: 'Settlement number',
    periodStart: 'Period start',
    periodEnd: 'Period end',
    openBatch: 'Open settlement details',
    retry: 'Retry',
    permissionDenied: 'You do not have permission to view settlement reports',
    loadFailed: 'Failed to load the settlement report',
    detailFailed: 'Failed to load grouped batches',
    empty: 'No closed settlement report data',
    filteredEmpty: 'No report rows match the filters',
    emptyBatches: 'No visible settlement batches in this group',
    rangeRequired: 'Select a UTC date range',
    rangeInvalid: 'The UTC range must contain 1 to 31 days',
