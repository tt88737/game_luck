  ...
  <div class="p-2">
      ...
      <div v-show="showSearch" class="mb-[10px]">
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            <el-form-item label="冻结号" prop="freezeNo">
              <el-input v-model="queryParams.freezeNo" placeholder="请输入冻结号" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            ...
            <el-form-item label="状态" prop="status">
              <el-select v-model="queryParams.status" placeholder="冻结状态" clearable>
    ...
    <el-card shadow="hover">
      ...
      <el-table v-loading="loading" border :data="freezeList">
        <el-table-column label="冻结号" align="center" prop="freezeNo" min-width="180" :show-overflow-tooltip="true" />
        ...
        <el-table-column label="冻结金额" align="right" prop="amount" min-width="130" />
