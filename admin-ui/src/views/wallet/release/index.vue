  ...
  <div class="p-2">
    ...
    <el-card shadow="hover">
      ...
      <el-table v-loading="loading" border :data="releaseList">
        ...
        <el-table-column :label="tt('释放模式')" align="center" prop="releaseMode" min-width="140">
        ...
        <el-table-column :label="tt('状态')" align="center" prop="releaseStatus" width="110">
          <template #default="scope">
            <el-tag :type="walletStatusType(scope.row.releaseStatus)">{{ businessLabel('walletReleaseStatus', scope.row.releaseStatus, tt) }}</el-tag>
          </template>
        </el-table-column>
...
const modeOptions = businessOptions('walletReleaseMode', tt);
const statusOptions = businessOptions('walletReleaseStatus', tt);
