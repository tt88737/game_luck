  ...
  <div class="p-2">
      ...
      <div v-show="showSearch" class="mb-[10px]">
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            <el-form-item :label="tt('交易号')" prop="transactionNo">
              <el-input v-model="queryParams.transactionNo" :placeholder="tt('请输入交易号')" clearable @keyup.enter="handleQuery" />
            </el-form-item>
    ...
    <el-card shadow="hover">
      ...
      <el-table v-loading="loading" border :data="transactionList">
        <el-table-column :label="tt('交易号')" align="center" prop="transactionNo" min-width="180" :show-overflow-tooltip="true" />
