...
-- Phase 46 payment settlement report menu (idempotent delete + insert).
...
INSERT INTO sys_menu
(menu_id,menu_name,parent_id,order_num,path,component,query_param,is_frame,is_cache,menu_type,visible,status,perms,icon,create_dept,create_by,create_time,update_by,update_time,remark) VALUES
(2034,'支付结算报表',1900,8,'payment-settlement-report','payment/payment-settlement-report/index','',1,0,'C','0','0','payment:settlementReport:list','chart',103,1,NOW(),NULL,NULL,'已关闭支付结算批次只读财务报表'),
(20341,'支付结算报表查询',2034,1,'#','','',1,0,'F','0','0','payment:settlementReport:list','#',103,1,NOW(),NULL,NULL,''),
(20342,'支付结算批次明细',2034,2,'#','','',1,0,'F','0','0','payment:settlementReport:query','#',103,1,NOW(),NULL,NULL,''),
