...
import com.gameluck.common.core.domain.dto.DictDataDTO;
import com.gameluck.common.core.domain.dto.DictTypeDTO;
import com.gameluck.common.core.exception.ServiceException;
import com.gameluck.common.core.service.DictService;
...
import com.gameluck.system.domain.SysDictData;
import com.gameluck.system.domain.SysDictType;
import com.gameluck.system.domain.bo.SysDictTypeBo;
import com.gameluck.system.domain.vo.SysDictDataVo;
import com.gameluck.system.domain.vo.SysDictTypeVo;
import com.gameluck.system.mapper.SysDictDataMapper;
import com.gameluck.system.mapper.SysDictTypeMapper;
import com.gameluck.system.service.ISysDictTypeService;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService, DictService {
    ...
    public void deleteDictTypeByIds(List<Long> dictIds) {
        ...
        list.forEach(x -> {
            ...
            if (assigned) {
                throw new ServiceException(MessageUtils.message("system.dict.type.assigned.delete.forbidden", x.getDictName()));
            }
        });
