...
public class SysTenantPackageBo extends BaseEntity {
     ...
     * 租户套餐id
     */
    @NotNull(message = "{system.tenant.package.id.required}", groups = { EditGroup.class })
    private Long packageId;

    /**
     * 套餐名称
     */
    @NotBlank(message = "{system.tenant.package.name.required}", groups = { AddGroup.class, EditGroup.class })
    private String packageName;

    /**
     * 关联菜单id
     */
    @AutoMapping(target = "menuIds", expression = "java(com.gameluck.common.core.utils.StringUtils.joinComma(source.getMenuIds()))")
