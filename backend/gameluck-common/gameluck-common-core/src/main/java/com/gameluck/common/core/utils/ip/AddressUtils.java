package com.gameluck.common.core.utils.ip;

import cn.hutool.http.HtmlUtil;
import lombok.AccessLevel;
import lombok.NoArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import com.gameluck.common.core.utils.NetUtils;
...
public class AddressUtils {
    ...
    // 内网地址
    public static final String LOCAL_ADDRESS = "PRIVATE_IP";
    ...
    public static String getRealAddressByIP(String ip) {
        ...
        if ((isIPv4 && NetUtils.isInnerIP(ip)) || (isIPv6 && NetUtils.isInnerIPv6(ip))) {
            return MessageUtils.message("ip.local.address");
        }
