...
import com.gameluck.common.excel.annotation.ExcelDictFormat;
import com.gameluck.common.excel.annotation.ExcelDynamicOptions;
            ...
            if (field.isAnnotationPresent(ExcelDictFormat.class)) {
                ...
                if (StringUtils.isNotBlank(dictType)) {
                    ...
                    Collection<String> values = Optional.ofNullable(dictService.getAllDictByDictType(dictType))
                        .orElseThrow(() -> new ServiceException(MessageUtils.message("excel.dict.not.exists", dictType)))
                        .values();
